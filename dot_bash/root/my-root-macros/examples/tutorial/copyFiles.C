...
//with the name of the source file.(uncomment in line 20 ->mkdir() )
//After execution of:
// root > .x copyFiles.C
...
void copyFiles() {
  ...
  TFile *f = new TFile("TH1FHist_TPC.root","recreate");
  CopyFile("TH2FHist_TPC_SDD.root");
  CopyFile("TH2FHist_TPC_SSD.root");
  f->ls();
  delete f;
}
